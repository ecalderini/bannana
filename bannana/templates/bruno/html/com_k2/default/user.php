...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> yjk2-main-holder2">
  ...
  <div class="userBlock">
    ...
    <!-- Item add link --> 
    <span class="userItemAddLink"> <a data-k2-modal="edit" href="<?php echo $this->addLink; ?>"> <?php echo JText::_('K2_POST_A_NEW_ITEM'); ?> </a> </span>
    <?php endif; ?>
  ...
  <div class="userItemList">
    ...
    <div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>"> 
      ...
      <div class="userItemBody yjk2-body"> 
        ...
        <!-- Item Image -->
        <div class="userItemImageBlock yjk2-image"> <span class="userItemImage"> <a href="<?php echo $item->link; ?>" title="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>">
          <?php if ($hovereffect == 1 ): ?>
          <span class="yj-hover-effect"> <img src="<?php echo $item->imageXLarge; ?>" alt="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>" style="width:<?php echo $this->params->get('itemImageGeneric'); ?>px; height:auto;" /> </span>
          <?php else: ?>
          <img src="<?php echo $item->imageXLarge; ?>" alt="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>" style="width:<?php echo $this->params->get('itemImageGeneric'); ?>px; height:auto;" />
          <?php endif; ?>
          </a> </span>
          <div class="clr"></div>
        </div>
        ...
        <div class="userItemHeader yjk2-header">
          ...
          <h3 class="userItemTitle yjk2-title">
            ...
            <!-- Item edit link --> 
            <span class="userItemEditLink"> <a data-k2-modal="edit" href="<?php echo $item->editLink; ?>"> <?php echo JText::_('K2_EDIT_ITEM'); ?> </a> </span>
            <?php endif; ?>
          ...
          <div class="yjk2-details">
            ...
            <!-- Date created -->
            <div class="userItemDateCreated"> <?php echo JHTML::_('date', $item->created , JText::_('YJ_DATE_FORMAT')); ?> </div>
            <?php endif; ?>
        ...
        <!-- Item introtext -->
        <div class="userItemIntroText yjk2-intro"> <?php echo $item->introtext; ?> </div>
        <?php endif; ?>
        <div class="clr"></div>
      ...
      <div class="userItemLinks">
        ...
        <!-- Item tags -->
        <div class="userItemTagsBlock yjk2-tags">
      ...
      <!-- Item "read more..." link -->
      <div class="userItemReadMore"> <a class="button-color" href="<?php echo $item->link; ?>"> <?php echo JText::_('YJ_READMORE'); ?> </a> </div>
      <?php endif; ?>
      <div class="clr"></div>
