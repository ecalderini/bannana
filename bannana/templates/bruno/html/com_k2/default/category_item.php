...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?> yjk2-main-holder"> 
  ...
  <div class="catItemBody yjk2-body"> 
    ...
    <!-- Item Image -->
    <div class="catItemImageBlock yjk2-image"> <span class="catItemImage"> <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
    ...
    <div class="catItemHeader yjk2-header">
      ...
      <div class="yjk2-details">
        ...
        <!-- Date created -->
        <div class="catItemDateCreated"> <?php echo JHTML::_('date', $this->item->created , JText::_('YJ_DATE_FORMAT')); ?> </div>
        <?php endif; ?>
        <?php if($this->item->params->get('catItemAuthor')): ?>
        <!-- Item Author -->
        <div class="catItemAuthor"> <?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?>
    ...
    <!-- Item introtext -->
    <div class="catItemIntroText yjk2-intro"> <?php echo $this->item->introtext; ?> </div>
    <?php endif; ?>
    <div class="clr"></div>
    ...
    <div class="catItemExtraFields">
      ...
      <ul>
        ...
        <li class="<?php echo ($key%2) ? "odd" : "even"; ?> type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
          ...
          <?php else: ?>
          <span class="catItemExtraFieldsLabel"><?php echo $extraField->name; ?></span> <span class="catItemExtraFieldsValue"><?php echo $extraField->value; ?></span>
          <?php endif; ?>
        </li>
        <?php endif; ?>
        <?php endforeach; ?>
  ...
  <!-- Item "read more..." link -->
  <div class="catItemReadMore"> <a class="button-color" href="<?php echo $this->item->link; ?>"> <?php echo JText::_('YJ_READMORE'); ?> </a> </div>
  <?php endif; ?>
  <div class="clr"></div>
