...
(function ($) {
    $(function () {
	  ...
	  /*left*/
	  sr.reveal('.bslides .yjsg-col-1-2:first-child', { duration:1200,delay: 400,origin:'left',distance:'200px',viewFactor  : 0.5,easing:'cubic-bezier(0.6, 0.2, 0.1, 1)' });
	  sr.reveal('.bproductstitle .h2_holder,.bbestsellertitle .h2_holder,.btestemonials .h2_holder,.bblognewstitle .h2_holder', { duration:1200,origin:'left',delay: 0,distance:'200px',easing:'cubic-bezier(0.6, 0.2, 0.1, 1)' });
	  /*right*/
	  sr.reveal('.bslides .yjsg-col-1-2:last-child', { duration:1200,delay: 800,origin:'right',distance:'200px',easing:'cubic-bezier(0.6, 0.2, 0.1, 1)' });
	  sr.reveal('.bproductstitle .module_subtitle,.bbestsellertitle .module_subtitle,.btestemonials .module_subtitle,.bblognewstitle .module_subtitle', { duration:1200,origin:'right',delay: 400,distance:'200px',easing:'cubic-bezier(0.6, 0.2, 0.1, 1)' });
	  /*top*/
	  sr.reveal('.slide-price', { duration:1200,origin:'top',delay: 1200,distance:'200px',easing:'cubic-bezier(0.6, 0.2, 0.1, 1)' });
	  sr.reveal('.bproducts .hikashop_product', { duration:1200,origin:'top',delay: 100,distance:'200px',easing:'cubic-bezier(0.6, 0.2, 0.1, 1)' });
