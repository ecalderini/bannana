...
<div class="yjme_holder">
  ...
  <div class="yjme_item">
    <div class="yjme_item_in yjmeitem<?php echo $yj_get_items['item_id']?><?php echo $last ?>">
      ...
      <div class="imageholder" style="width:<?php echo $img_width ?>;height:<?php echo $img_height ?>;float:<?php echo $align ?>;"> <a class="item_image"  style="width:<?php echo $img_width ?>;height:<?php echo $img_height ?>;" href="<?php echo $yj_get_items['item_url'] ?>" >
        <?php if ($hovereffect == 1 ): ?>
        <span class="yj-hover-effect"> <img src="<?php echo $yj_get_items['img_url'] ?>" alt="<?php echo $yj_get_items['item_title']?>" /> </span>
        <?php else: ?>
      ...
      <?php endif;?>
      <?php if ($show_title == 1 ):  ?>
      <a class="item_title" href="<?php echo $yj_get_items['item_url'] ?>"> <?php echo $yj_get_items['item_title']?> </a>
      <?php endif; ?>
      <?php if ($show_cat_title == 1 || $show_date== 1 || $show_author == 1  ):?>
      <div class="clearnf"></div>
      <div class="item_details">
        <?php if ($show_cat_title == 1):?>
        <div class="item_category"> <a href="<?php echo $yj_get_items['cat_url'] ?>"> <?php echo $yj_get_items['cat_title']?>
          <?php if($show_cat_title == 1 && $show_date == 1):?>
          -
          <?php endif; ?>
          </a> </div>
        <?php endif; ?>
        <?php if ($show_date == 1):?>
        <div class="item_cdate"> <?php echo $yj_get_items['item_date']?> </div>
        <?php endif; ?>
        ...
        <div class="item_author">
          ...
          <?php echo $author ?>
          <?php else: ?>
          <a href="<?php echo $yj_get_items['author_url'] ?>"> <?php echo $author ?> </a>
          <?php endif; ?>
        </div>
        <?php endif; ?>
      </div>
      ...
      <?php endif; ?>
      <?php if ($show_intro == 1 ):?>
      <p class="item_intro"> <?php echo $yj_get_items['item_intro']?> </p>
      <?php endif; ?>
      <?php if ($show_read == 1 ): ?>
      <a class="button-color" href="<?php echo $yj_get_items['item_url']?>"> <?php echo JText::_('YJ_READMORE');?> </a>
      <?php endif; ?>
    </div>
  </div>
  <?php endforeach; ?>
