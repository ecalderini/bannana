...
<div class="yjsg-userpages reset">
	...
	<?php endif ; ?>
	<form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=reset.request'); ?>" method="post" class="yjsg-form form-validate">
