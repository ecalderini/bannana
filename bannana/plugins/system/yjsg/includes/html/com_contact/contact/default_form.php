...
<div class="contact-form">
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="yjsg-form form-validate">
						...
						<div class="yjsg-form-group">
							...
							<?php else:?>
								<?php echo $field->label; ?>
									...
									<?php endif; ?>
								<div class="yjsg-element-holder"><?php echo $field->input;?></div>
							<?php endif;?>
						</div>
					<?php endforeach;?>
				<?php endif ?>
			<?php endforeach;?>
			<div class="yjsg-element-holder"><button class="button validate" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
