...
<div class="userpageswrap useredit <?php echo $this->pageclass_sfx?>">
		...
		<div class="profile-edit<?php echo $this->pageclass_sfx?>">
			...
			<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php 
									...
									$output = str_replace('class="','class="form-control ',$field->input);
				...
				<div class="user-actions">
					<button type="submit" class="btn btn-primary button validate"><span><?php echo JText::_('JSUBMIT'); ?></span></button>
					<a class="btn btn-primary button" href="<?php echo JRoute::_(''); ?>" title="<?php echo JText::_('JCANCEL'); ?>">
