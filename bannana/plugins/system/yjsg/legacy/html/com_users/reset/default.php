...
<div class="userpageswrap reset<?php echo $captcha_class ?>">
	<div class="userpages">
		...
		<?php endif ; ?>
		<form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=reset.request'); ?>" method="post" class="form-validate form-form">
