...
<div class="contact-form">
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal form-form-horizontal">
		<fieldset class="form-fieldset">
			...
			<?php foreach ($this->form->getFieldsets() as $fieldset): ?>
				...
				<?php endif ?>
			<?php endforeach;?>
			<div class="form-btnx"><button class="button btn btn-primary validate" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
